...
func DoLatencyTest(t *testing.T, upLatency, downLatency *toxics.Latency) {
	WithEchoProxy(t, func(conn net.Conn, response chan []byte, proxy *proxy.Proxy) {
		if upLatency == nil {
			upLatency = &toxics.Latency{}
		} else {
...
func TestUpstreamLatency(t *testing.T) {
	DoLatencyTest(t, &toxics.Latency{Latency: 100}, nil)
}

func TestDownstreamLatency(t *testing.T) {
	DoLatencyTest(t, nil, &toxics.Latency{Latency: 100})
}

func TestFullstreamLatencyEven(t *testing.T) {
	DoLatencyTest(t, &toxics.Latency{Latency: 100}, &toxics.Latency{Latency: 100})
}

func TestFullstreamLatencyBiasUp(t *testing.T) {
	DoLatencyTest(t, &toxics.Latency{Latency: 1000}, &toxics.Latency{Latency: 100})
}

func TestFullstreamLatencyBiasDown(t *testing.T) {
	DoLatencyTest(t, &toxics.Latency{Latency: 100}, &toxics.Latency{Latency: 1000})
}

func TestZeroLatency(t *testing.T) {
	DoLatencyTest(t, &toxics.Latency{Latency: 0}, &toxics.Latency{Latency: 0})
}

func TestLatencyCloseRace(t *testing.T) {
	...
	for i := 0; i < 1000; i++ {
		proxy.Toxics.AddToxicJson(ToxicToJson(t, "", "latency", "upstream", &toxics.Latency{Latency: 10}))
...
func TestTwoLatencys(t *testing.T) {
	WithEchoProxy(t, func(conn net.Conn, response chan []byte, proxy *proxy.Proxy) {
		toxics := []*toxics.Latency{{Latency: 500}, {Latency: 500}}
...
func TestLatencyBandwidth(t *testing.T) {
	...
	proxy.Toxics.AddToxicJson(ToxicToJson(t, "", "latency", "", &toxics.Latency{Latency: 100}))
