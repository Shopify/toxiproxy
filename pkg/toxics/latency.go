...
// The Latency passes data through with the a delay of latency +/- jitter added.
type Latency struct {
...
func (t *Latency) GetBufferSize() int {
	return 1024
}

func (t *Latency) delay() time.Duration {
